...
2. Extinct 1990s platform requiring a VPS: *simplify*
3. Performance
...
<div>
  ...
  - Platform
    ...
    - Static hosting - anywhere and free
  - Performance!
    - All pages fast
    - Prefetch pages/images
    - Offline support
...
## What Happens When Gatsby Builds?

[Great explanation on the Gatsby site](https://www.gatsbyjs.org/docs/overview-of-the-gatsby-build-process/#what-happens-when-you-run-gatsby-build)
...
- _This_ slide deck built with Gatsby-based [mdx-deck](https://github.com/jxnblk/mdx-deck) !
- Source on GitHub:   https://github.com/saschwarz/nwjs-gatsby
